const SocialMedia = (): JSX.Element => (
  <div className='mt-20 text-center'>
    ...
    <div className='my-10 flex flex-row items-center justify-center'>
      <a className='px-4' href='//www.facebook.com/acmatutd'>
        <img src='/img/fb.svg' width='30' height='auto' />
      </a>
      <a className='px-4' href='//www.instagram.com/utdacm/'>
        <img src='/img/ig.svg' width='30' height='auto' />
      </a>
      <a className='px-4' href='//www.linkedin.com/company/acmutd/'>
        <img src='/img/in.svg' width='30' height='auto' />
      </a>
    </div>
    <div>
      or, contact us at{' '}
      <a href='mailto:hacktoberfest@acmutd.co' className='text-fuschia'>
